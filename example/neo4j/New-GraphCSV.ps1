...
if ( $authERROR ) { $configERROR = ( $true ); return } else {
  ...
  @('About', 'Auth', 'Cart', 'Home', 'Product', 'Profile', 'RBAC', 'Shop') | ForEach-Object {
    ...
    switch -Wildcard ("$( $csvNode._label )") {
      "*About*" { $csvNode._label = "$_"; $csvNode._cols += ($Get_CSVSchema._about); $csvNode._name = ("about"); $csvNode._rows += @(",,,,,,,,,`n", ",,,,,,,,,`n", ",,,,,,,,,`n"); break }
      "*Auth*" { $csvNode._label = "$_"; $csvNode._cols += ($Get_CSVSchema._auth); $csvNode._name = ("auth"); $csvNode._rows += @(",,,,,,,,,`n", ",,,,,,,,,`n", ",,,,,,,,,`n"); break }
      "*Cart*" { $csvNode._label = "$_"; $csvNode._cols += ($Get_CSVSchema._cart); $csvNode._name = ("cart"); $csvNode._rows += @(",,,,,,,,,`n", ",,,,,,,,,`n", ",,,,,,,,,`n"); break }
      "*Home*" { $csvNode._label = "$_"; $csvNode._cols += ($Get_CSVSchema._home); $csvNode._name = ("home"); $csvNode._rows += @(",,,,,,,,,`n", ",,,,,,,,,`n", ",,,,,,,,,`n"); break }
      { $_ -LIKE "*Product*" -OR $_ -LIKE "*Apparel*" -OR $_ -LIKE "*Art*" -OR $_ -LIKE "*Decor*" -OR $_ -LIKE "*Jewlery*" } {
        $csvNode._label = "$_"; $csvNode._cols += ($Get_CSVSchema._product); $csvNode._name = ("shop"); $csvNode._rows += @(",,,,,,,,,`n", ",,,,,,,,,`n", ",,,,,,,,,`n");
      ...
      { $_ -LIKE "*Profile*" -OR $_ -LIKE "*User*" -OR $_ -LIKE "*Teammate*" -OR $_ -LIKE "*Friend*" } {
        $csvNode._label = "$_"; $csvNode._cols += ($Get_CSVSchema._profile); $csvNode._name = ("profile"); $csvNode._rows += @(",,,,,,,,,`n", ",,,,,,,,,`n", ",,,,,,,,,`n");
      ...
      "*RBAC*" { $csvNode._label = "$_"; $csvNode._cols += ($Get_CSVSchema._rbac); $csvNode._name = ("auth"); $csvNode._rows += @(",,,,,,,,,`n", ",,,,,,,,,`n", ",,,,,,,,,`n"); break }
      "*Shop*" { $csvNode._label = "$_"; $csvNode._cols += ($Get_CSVSchema._shop); $csvNode._name = ("shop"); $csvNode._rows += @(",,,,,,,,,`n", ",,,,,,,,,`n", ",,,,,,,,,`n"); break }
      default { break }
    };
...
if ( $configERROR ) { return } else { try { New-CSVGraph @{ _basePath = [String]( $Neo4jPath ); _nodes = [System.Collections.ArrayList]( $Set_CSVSchema ) } } catch { throw ; return } }